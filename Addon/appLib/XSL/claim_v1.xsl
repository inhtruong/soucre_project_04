...
<xsl:template match="DOCUMENT">
	...
	<tr>
		...
		<td class="item"><xsl:value-of select="./OCCURRENCEDATE" /></td>
	</tr>
	<tr>
		<td class="label">発生時刻</td>
		<td class="item"><xsl:value-of select="./OCCURRENCETIME" /></td>
	</tr>
	</table>
	<h2>発信元</h2>
	<table class="detail">
	<tr>
		...
		<td class="item"><xsl:value-of select="./PARTNERNAME" /></td>
	</tr>
	<tr>
		<td class="label">顧客ご担当者</td>
		<td class="item"><xsl:value-of select="./PARTNERRESPNAME" /></td>
	</tr>
	<tr>
		<td class="label">手段</td>
		<td class="item"><xsl:value-of select="./OBTAINMEASURE" /></td>
	</tr>
	</table>
	<table class="detail margin">
	<tr>
		<td class="label">件名</td>
		<td class="item"><xsl:value-of select="./SUBJECT" /></td>
	</tr>
	<xsl:choose>
	...
	<tr>
		<td class="label">内容・状況</td>
		<td class="item"><xsl:apply-templates select="./CONTENT" /></td>
	</tr>
	<tr>
		<td class="label">対応期限</td>
		<td class="item"><xsl:value-of select="./CORRESPONDAUTH" /></td>
	</tr>
	<tr>
	...
	<table class="detail">
	<tr>
		<td class="label">顧客担当社員</td>
		<td class="item"><xsl:value-of select="./PARTNERRESP" /></td>
	</tr>
	<xsl:choose>
		<xsl:when test="./FLAGHIDNAME ='0'"></xsl:when>
		<xsl:otherwise>
			<tr>
				<td class="label">商品担当社員</td>
		    	<td class="item"><xsl:value-of select="./COMMODRESP" /></td>
			</tr>
		</xsl:otherwise>
	</xsl:choose>   
	<tr>
		<td class="label">その他通知先</td>
