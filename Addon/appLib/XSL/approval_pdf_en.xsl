	...
	<xsl:template match="DOCUMENT">
		...
		<xsl:text disable-output-escaping="yes">&lt;div class="contents"&gt;</xsl:text>
			...
			<xsl:value-of select="./PDFFILEDOCID" />
	     	<xsl:text disable-output-escaping="yes">&amp;beforePrint=true&amp;afterPrint=true&amp;pagesLoaded=true&amp;pageChange=true&amp;openFile=true&amp;download=true&amp;viewBookmark=true&amp;print=true&amp;fullScreen=true&amp;find=true#&amp;locale=en#&amp;pagemode=none&amp;errorMessage=undefined&amp;errorAppend=true"  &gt;&lt;/iframe&gt;
		    </xsl:text>
		...
		<script type="text/javascript">
			...
			function fncOnLoad() {
				var ObjectA = "<a href="+link+">Download content</a>";
