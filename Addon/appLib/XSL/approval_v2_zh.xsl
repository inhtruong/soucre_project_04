			...
			<xsl:when test="../RRDBBS">
				<div class="contents margin">
					<table class="detail">
						...
						<tr>
							<td class="label">NaviView通知期间</td>
							<td class="item">
								<xsl:choose>
			...
			<xsl:choose>
				<xsl:when test="../RFM_USERFORMAT">
					...
					<script type="text/javascript">
						...
						var ObjectA = "<a href='+link+'>下载申请文件</a>";
						function fncOnLoad() {
							elem.innerHTML = 'Office文档工作流程不可用。<br/>' + ObjectA;
						}
						fncOnLoad();
					</script>
				</xsl:when>
