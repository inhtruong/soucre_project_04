...
<xsl:stylesheet
	...
	<xsl:template match="DOCUMENT">
		...
		<xsl:value-of select="./PDFFILEDOCID" />
     	<xsl:text disable-output-escaping="yes">&amp;beforePrint=true&amp;locale=en#&amp;afterPrint=true&amp;pagesLoaded=true&amp;pageChange=true&amp;openFile=true&amp;download=true&amp;viewBookmark=true&amp;print=true&amp;fullScreen=true&amp;find=true#&amp;pagemode=none&amp;errorMessage=undefined&amp;errorAppend=true"  &gt;&lt;/iframe&gt;
	    </xsl:text>
		...
		<xsl:value-of select="./PDFFILEDOCID" />
		<xsl:text disable-output-escaping="yes">" &gt;Download content&lt;/a&gt; &lt;/div&gt;</xsl:text>
