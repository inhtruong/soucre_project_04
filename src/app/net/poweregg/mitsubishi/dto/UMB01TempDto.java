...
@ConversationScoped
public class UMB01TempDto implements Serializable {
	 ...
	 * @return the appRecNo
	 */
	public String getAppRecNo() {
		return appRecNo;
	}

	/**
	 * @param appRecNo the appRecNo to set
	 */
	public void setAppRecNo(String appRecNo) {
