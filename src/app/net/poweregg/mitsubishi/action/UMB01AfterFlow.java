 ...
 * 稟議書 事後処理
 */
public class UMB01AfterFlow implements IProcAfterFlow {

    /**
     * デフォルトコンストラクタ
     */
    public UMB01AfterFlow()  {
        super();
    }
    ...
    public void doProcess(Long appRecepNo, Integer historyNo, String status) {
        ...
        try {
            ...
            ApprovalServiceUmb service = (ApprovalServiceUmb)icx.lookup("java:global/pe4j-ear/wf-mitsubishi/ApprovalServiceUbmBean");
	        service.commitApproval(appRecepNo, status);
        } catch (Exception ex) {
