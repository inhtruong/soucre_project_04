...
<xsl:choose>
	<xsl:when test="./PATTERN='0'">
		<TABLE class="detail umb" id="umb" style="width: 1775px">
	        ...
	        <TR>
				<TD class="label" colspan="2">小口配送単価(決定値)</TD>
				<TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">手入力</TD>
			...
			<TR>
				<TD class="label" colspan="2">小口着色単価(決定値)</TD>
				<TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">手入力</TD>
	...
	<xsl:when test="PATTERN='3' or PATTERN='4'">
		<TABLE class="detail umb" id="umb">
	        ...
	        <TR>
	            ...
	            <TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">
	            	<xsl:value-of select="./CALUNITPRICEPARCEL"/>
	            </TD>
			</TR>
			<TR>
				<TD class="label" colspan="2">小口着色単価(決定値)</TD>
	...
	<xsl:when test="PATTERN='5' or PATTERN='6'">
		<TABLE class="detail umb" id="umb">
			...
			<TR>
	            ...
	            <TD class="itemUmb">手入力</TD>
	            <TD class="itemUmb">
	            	<xsl:value-of select="./CALUNITPRICEFOREHEAD"/>
	            </TD>
			</TR>
    	</TABLE>
	</xsl:when>
	...
	<xsl:when test="PATTERN='7' or PATTERN='8'">
		<TABLE class="detail umb" id="umb">
			<TR>
	            ...
	            <TH style="width: 411px" class="labelUmb">直販</TH>
	            <TH style="width: 411px" class="labelUmb">割増無</TH>
	            <TH style="width: 411px" class="labelUmb">小口着色<BR />(100-299kg)</TH>
	            <TH style="width: 411px" class="labelUmb">小口着色+配送<BR />（0-99kg)</TH>
	        </TR>
	        <TR>
	            <TD class="labelUmb" colspan="2">末端単価</TD>
	            <TD class="itemUmb">
